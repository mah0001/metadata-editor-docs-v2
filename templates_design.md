...
> This section is about designing templates for the various data types. For the design of administrative metadata templates, see chapter **Documenting data: Administrative metadata**.
